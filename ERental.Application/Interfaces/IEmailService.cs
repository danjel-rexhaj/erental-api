...
public interface IEmailService
{
    ...
    Task SendBookingCancelledAsync(string toEmail, string emri, string makina, string dataFillimit, string dataPerfundimit, string? carPhotoUrl = null, string? arsyeja = null);
